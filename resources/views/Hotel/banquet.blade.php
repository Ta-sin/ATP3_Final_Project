    ...
    <div class="row justify-content-center">
      <div class="col-12 col-md-8 col-lg-8 col-xl-6">
        ...
        <div class="row align-items-center">
          ...
          <div class="col mt-4">
            <input type="text" class="form-control" placeholder="Banquete Name" name="bname"  id="bname">
          </div>
        </div>
        <div class="row align-items-center mt-4">
          <div class="col">
            <input type="text" class="form-control" placeholder="Banquete price" name="bprice" id="bprice">
          </div>
        </div>
        <div class="row align-items-center mt-4">
          <div class="col-md-12">
              <div class="form-group form-group-textarea mb-md-0">
                  <textarea class="form-control" placeholder="Detailse *" required="required" data-validation-required-message="Please enter room details" name="bdescription" id="rdescription"></textarea>
        ...
        <div class="row justify-content-start mt-4">
          <div class="col">
              ...
              <input type="submit" name="signup" id="signup" class="btn btn-primary mt-4" value="REGISTER"/>
