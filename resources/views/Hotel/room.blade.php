    ...
    <div class="row justify-content-center">
      <div class="col-12 col-md-8 col-lg-8 col-xl-6">
        ...
        @endif
          ...
          <form method="POST" action="{{route('room.add')}}" class="register-form" id="register-form">
          <input type="hidden" name="_token" value="{{csrf_token()}}">
        <div class="row align-items-center">
          <div class="col-lg-6">
          </div>
          <div class="col mt-4">
            <input type="text" class="form-control" placeholder="Room Name" name="rname"  id="rname">
          </div>
        </div>
        <div class="row align-items-center mt-4">
          <div class="col">
            <input type="text" class="form-control" placeholder="price" name="rprice" id="rprice">
          </div>
        </div>
        <div class="row align-items-center mt-4">
          <div class="col-md-12">
              <div class="form-group form-group-textarea mb-md-0">
                  <textarea class="form-control" placeholder="Your Message *" required="required" data-validation-required-message="Please enter room details" name="rdescription" id="rdescription"></textarea>
